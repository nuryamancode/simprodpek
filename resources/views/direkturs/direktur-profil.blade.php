@extends('direkturs.layouts.direktur-base', ['title' => 'Profil'])
                        ...
                        <div class="row">
                            <div class="col-5">
                                <div class="img-profil">
                                    ...
                                    @else
                                        <img src="{{ asset('assets/dokumen/foto_profil/' . $direktur->foto_profil) }}"
                                            alt="User Profile" width="200px" height="200px">
                                    @endif
                                </div>
                            </div>
                            <div class="col-7">
                                ...
                                @else
                                    <h2 class="title-name">{{ $direktur->nama_lengkap }}</h2>
