@extends('direkturs.layouts.direktur-base', ['title' => 'Edit Profil'])
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="img-profil">
                                ...
                                @else
                                    <img id="previewImage"
                                        src="{{ asset('assets/dokumen/foto_profil/' . $direktur->foto_profil) }}"
                                        alt="User Profile" width="200px" height="200px">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="name" class="form-control" id="exampleInputEmail1" name="name"
                                    aria-describedby="emailHelp" value="{{ $direktur->nama_lengkap ?? '' }}">
                            </div>
                        </div>
