@extends('hr.layouts.hr-base', ['title' => 'Profil'])
                    ...
                    <div class="row">
                        <div class="col-5">
                            <div class="img-profil">
                                ...
                                @else
                                    <img src="{{ asset('assets/dokumen/foto_profil/' . $hr->foto_profil) }}"
                                        alt="User Profile" width="200px" height="200px">
                                @endif
                            </div>
                        </div>
        ...
        <div class="card-body">
            <div class="row mb-4">
                ...
                <div class="col text-end">
                    <a href="{{ route('hr.edit.profil') }}" class="btn btn-warning text-end">Ubah Profil</a>
                </div>
            </div>
            <div class="row">
                <div class="col">
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('hr.ganti.password') }}" method="POST">
                @csrf
