                    ...
                    <div class="dropdown ms-5">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notificationDropdown"
                                ...
                                @else
                                    @foreach ($notifikasi as $item)
                                        <a class="dropdown-item"
                                            href="{{ route('karyawan.notifikasi.dibaca', $item->id) }}">
                                            <div class="d-flex justify-content-between">
                                                <div>
                            ...
                            <li><a class="dropdown-item text-center text-primary"
                                    href="{{ route('karyawan.notifikasi') }}">Lihat semua</a></li>
                        </ul>
                    </div>
                </li>
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                        <div class="message-body">
                            <a href="{{ route('karyawan.profil') }}"
                                class="{{ 'karyawann/profil' == request()->path() ? 'active' : '' }} {{ 'karyawann/edit-profil' == request()->path() ? 'active' : '' }} d-flex align-items-center gap-2 dropdown-item">
